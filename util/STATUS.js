const STATUS = {
	...
	S202 :{result : 202, resultDesc:"삭제 성공"},
	S203 :{result : 203, resultDesc:"삭제 성공 및 연쇄 삭제 발생"},
	E100 :{result : -100, resultDesc:"필수 파라메터 에러"},
	E101 :{result : -101, resultDesc:"cmd 에러"},
	E102 :{result : -102, resultDesc:"허용 범위 초과"},
	E103 :{result : -103, resultDesc:"해당 장르 없음"},
	E104 :{result : -104, resultDesc:"해당 매장 없음"},
	E200 :{result : -200, resultDesc:"Auth fail ( 인증 실패 -인증토큰 / 허용 IP / 허용 mac 에러 )"},
	E300 :{result : -300, resultDesc:"DB 요청 실패"},
